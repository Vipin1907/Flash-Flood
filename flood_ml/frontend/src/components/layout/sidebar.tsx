      ...
      {isOpen && (
        <>
          ...
          <motion.aside
            ...
            className="fixed top-0 left-0 bottom-0 w-72 bg-[#06080E]/98 backdrop-blur-2xl border-r border-[#151B29] flex flex-col h-screen select-none z-50 shadow-2xl shadow-black/80"
          >
            {/* Drawer Header with Logo & Close X Button */}
            <div className="p-5 border-b border-[#151B29] flex items-center justify-between">
              ...
              <button
                onClick={onClose}
                className="p-1.5 rounded-lg bg-white/[0.05] border border-white/10 text-slate-400 hover:text-white hover:bg-white/10 transition-colors cursor-pointer"
                title="Close Sidebar"
              >
                <X className="w-4 h-4" />
              </button>
            ...
            {/* Bottom Info Status */}
            <div className="p-4 border-t border-[#151B29] bg-[#05070B]">
              <div className="bg-[#090C15] border border-[#161D2C] rounded-xl p-3">
